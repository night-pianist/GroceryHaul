...
export declare class MessageApiRequestFactory extends BaseAPIRequestFactory {
    ...
    v1MessageStream(appId: string, limit?: number, iterator?: string, eventTypes?: Array<string>, channels?: Array<string>, after?: Date, _options?: Configuration): Promise<RequestContext>;
}
export declare class MessageApiResponseProcessor {
    ...
    v1MessageEventsSubscription(response: ResponseContext): Promise<MessageStreamOut>;
    v1MessageEventsSubscriptionCreateToken(response: ResponseContext): Promise<MessageSubscriberAuthTokenOut>;
