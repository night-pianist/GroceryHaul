...
class PromiseMessageApi {
    ...
    v1MessageStream(appId, limit, iterator, eventTypes, channels, after, _options) {
        const result = this.api.v1MessageStream(appId, limit, iterator, eventTypes, channels, after, _options);
        return result.toPromise();
    }
}
...
class PromiseStreamsApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_16.ObservableStreamsApi(configuration, requestFactory, responseProcessor);
    }
    appendToStream(appId, createStreamIn, idempotencyKey, _options) {
        const result = this.api.appendToStream(appId, createStreamIn, idempotencyKey, _options);
        return result.toPromise();
    }
    listStream(appId, _options) {
        const result = this.api.listStream(appId, _options);
        return result.toPromise();
    }
}
exports.PromiseStreamsApi = PromiseStreamsApi;
const ObservableAPI_17 = require("./ObservableAPI");
class PromiseTransformationTemplateApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_17.ObservableTransformationTemplateApi(configuration, requestFactory, responseProcessor);
    }
