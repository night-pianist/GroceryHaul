...
class ObjectMessageApi {
    ...
    v1MessageStream(param, options) {
        return this.api.v1MessageStream(param.appId, param.limit, param.iterator, param.eventTypes, param.channels, param.after, options).toPromise();
    }
}
...
class ObjectStreamsApi {
    constructor(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_16.ObservableStreamsApi(configuration, requestFactory, responseProcessor);
    }
    appendToStream(param, options) {
        return this.api.appendToStream(param.appId, param.createStreamIn, param.idempotencyKey, options).toPromise();
    }
    listStream(param, options) {
        return this.api.listStream(param.appId, options).toPromise();
    }
}
exports.ObjectStreamsApi = ObjectStreamsApi;
