...
import { ListResponseEventOut } from '../models/ListResponseEventOut';
...
export declare class ObservableEventsApi {
    ...
    v1Events(limit?: number, iterator?: string, eventTypes?: Array<string>, channels?: Array<string>, after?: Date, _options?: Configuration): Observable<MessageStreamOut>;
}
...
export declare class ObservableMessageApi {
    ...
    v1MessageEventsSubscription(appId: string, subscriptionId: string, limit?: number, iterator?: string, eventTypes?: Array<string>, channels?: Array<string>, after?: Date, _options?: Configuration): Observable<MessageStreamOut>;
    ...
    v1MessageStream(appId: string, limit?: number, iterator?: string, eventTypes?: Array<string>, channels?: Array<string>, after?: Date, _options?: Configuration): Observable<MessageStreamOut>;
}
...
export declare class ObservableStreamsApi {
    private requestFactory;
    private responseProcessor;
    private configuration;
    constructor(configuration: Configuration, requestFactory?: StreamsApiRequestFactory, responseProcessor?: StreamsApiResponseProcessor);
    appendToStream(appId: string, createStreamIn: CreateStreamIn, idempotencyKey?: string, _options?: Configuration): Observable<void>;
    listStream(appId: string, _options?: Configuration): Observable<ListResponseEventOut>;
}
