...
export declare class ObjectEventsApi {
    ...
    v1Events(param: EventsApiV1EventsRequest, options?: Configuration): Promise<MessageStreamOut>;
}
...
export declare class ObjectMessageApi {
    ...
    v1MessageEventsSubscription(param: MessageApiV1MessageEventsSubscriptionRequest, options?: Configuration): Promise<MessageStreamOut>;
...
export interface StreamsApiAppendToStreamRequest {
    appId: string;
    createStreamIn: CreateStreamIn;
    idempotencyKey?: string;
}
export interface StreamsApiListStreamRequest {
    appId: string;
}
export declare class ObjectStreamsApi {
    private api;
    ...
    appendToStream(param: StreamsApiAppendToStreamRequest, options?: Configuration): Promise<void>;
    listStream(param: StreamsApiListStreamRequest, options?: Configuration): Promise<ListResponseEventOut>;
}
