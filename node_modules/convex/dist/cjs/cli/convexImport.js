...
const convexImport = new import_extra_typings.Command("import").summary("Import data from a file to your deployment").description(
  ...
  const fetch = (0, import_utils.deploymentFetch)(deploymentUrl);
...
function snapshotImportDashboardLink(deploymentName) {
  return deploymentName === void 0 ? "https://dashboard.convex.dev/d/settings/snapshot-export" : (0, import_dashboard.deploymentDashboardUrlPage)(deploymentName, "/settings/snapshot-export");
}
