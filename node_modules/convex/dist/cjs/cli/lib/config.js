...
function config2JSON(adminKey, functions, udfServerVersion, appDefinition, componentDefinitions) {
  return {
    adminKey,
    functions,
    udfServerVersion,
...
async function pushConfig2(ctx, adminKey, url, functions, udfServerVersion, appDefinition, componentDefinitions) {
