...
const checkedHttpRoutes = import_zod.z.object({
  routerPrefix: import_zod.z.array(import_zod.z.tuple([import_zod.z.string(), import_zod.z.string()])),
  routerExact: import_zod.z.array(import_zod.z.tuple([import_zod.z.string(), import_zod.z.string()])),
  mountedPrefix: import_zod.z.array(import_zod.z.string())
});
