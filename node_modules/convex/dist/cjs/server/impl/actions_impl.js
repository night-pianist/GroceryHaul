...
var import_reference = require("../components/reference.js");
...
function getFunctionAddress(functionReference) {
  ...
  } else if (functionReference[import_api.functionName]) {
    functionAddress = { name: functionReference[import_api.functionName] };
  } else {
    const referencePath = (0, import_reference.extractReferencePath)(functionReference);
    if (!referencePath) {
