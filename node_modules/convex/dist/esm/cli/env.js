...
async function callUpdateEnvironmentVariables(ctx, options, changes) {
  ...
  try {
    ...
    return deploymentType !== void 0 || deploymentName !== void 0 ? ` (on${deploymentType !== void 0 ? " " + chalk.bold(deploymentType) : ""} deployment${deploymentName !== void 0 ? " " + chalk.bold(deploymentName) : ""})` : "";
  } catch (e) {
