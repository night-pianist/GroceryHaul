...
import { z } from "zod";
export function componentServerJS(isRoot) {
  let result = `
  ${header(
...
export function componentServerStubDTS(isRoot) {
...
export async function componentServerDTS(ctx, startPush, rootComponent, componentDirectory) {
