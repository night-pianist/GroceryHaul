...
export declare function bundleImplementations(ctx: Context, rootComponentDirectory: ComponentDirectory, componentDirectories: ComponentDirectory[], nodeExternalPackages: string[], verbose?: boolean): Promise<{
    appImplementation: {
        schema: Bundle;
        functions: Bundle[];
